...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2025 at 03:15 PM
...
INSERT INTO `issues` (`issue_id`, `project_id`, `issue_key`, `summary`, `description`, `attachment`, `flagged`, `issue_type_id`, `status`, `priority`, `reporter_id`, `assignee_id`, `created_at`, `updated_at`) VALUES
...
(19, 6, 'PROJ6-2', '', '', NULL, NULL, 5, 'To Do', 'Mid', NULL, NULL, '2025-02-05 07:21:25', '2025-02-05 07:21:25'),
(20, 9, 'PROJ9-1', 'hello', '', NULL, NULL, 5, 'To Do', 'Mid', NULL, NULL, '2025-02-05 07:24:31', '2025-02-05 07:24:31'),
(21, 5, 'PROJ5-1', '', 'why', NULL, NULL, 15, 'To Do', 'Low', NULL, NULL, '2025-02-05 07:32:47', '2025-02-05 07:32:47'),
(22, 8, 'PROJ8-4', '', '', NULL, NULL, 1, 'To Do', 'Low', NULL, NULL, '2025-02-05 07:35:41', '2025-02-05 07:35:41'),
(23, 7, 'PROJ7-2', '', 'ugugguuo', NULL, NULL, 7, 'To Do', 'Low', NULL, NULL, '2025-02-05 07:39:46', '2025-02-05 07:39:46');
...
(1, 'KED', 'KEDAR Test', 'KEDAR Test', NULL, '2025-01-26 19:44:15'),
(2, 'Test2', 'TESt', 'TTESt', NULL, '2025-01-26 19:44:46'),
(3, 'PROJ123', 'Issue Tracking System', 'A project to manage and track issues.', 101, '2025-01-29 14:40:31'),
(5, 'PROJ122', 'Issue Tracking System', 'A project to manage and track issues.', 2, '2025-01-29 14:43:51'),
(6, 'PROJ128', 'Issue Tracking System', 'A project to manage and track issues.', NULL, '2025-01-29 14:47:06'),
(7, 'PROJ198', 'Issue Tracking System', 'A project to manage and track issues.', 553, '2025-01-29 14:52:30'),
(8, 'v123', 'v12', 'alm type', 45, '2025-01-30 04:50:56'),
(9, 'hkeokh', 'rher', '3wngj bh', 35, '2025-01-30 05:07:07');
...
--
ALTER TABLE `issuekeys`
  MODIFY `issue_key_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `issues`
--
ALTER TABLE `issues`
  MODIFY `issue_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `projects`
  MODIFY `project_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
